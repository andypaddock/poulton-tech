...
import { environments } from '../silverless/assets/environment/index.js';
...
export class Viewer {
  ...
  constructor (el, options) {
    ...
    this.renderer = window.renderer = new WebGLRenderer({antialias: true, logarithmicDepthBuffer: true});
